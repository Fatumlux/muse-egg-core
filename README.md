...
- `docs/`：架構、OC Pack、skills、自接 LLM 文件
...
詳見 [Anti-Amnesia 設計](docs/anti-amnesia.md)。
...
匯出 Pack 時會先在 `.museegg/backups/` 建立版本備份，方便回復到先前設定。
...
- v0.1.0：rule-based OC core、OC Studio、OC Pack import/export、生命文件層、OC skills、Telegram polling、file watcher skeleton、host-auto-provider、自我成長提案、分層記憶、生命狀態、權限中心、伴侶模式、Pack 版本備份
- v0.2.0：provider health checks、skill permission sandbox、memory ranking、桌寵小窗、網站同步 runtime
